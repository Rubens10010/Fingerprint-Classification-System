...
dataset = numpy.loadtxt("om_featuresDB2.dat", delimiter=" ",usecols=range(1,input_number+2))
  ...
  for f in l_fst_layer:
    ...
    for s in l_snd_layer:
      ...
      for t in l_trd_layer:
        ...
        filename = "models/4class/" +str(e)+ "_" + str(f) +"_"+  str(s)+"_" + str(t)+"_"
