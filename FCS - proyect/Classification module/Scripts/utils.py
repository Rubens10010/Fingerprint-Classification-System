...
# This is not mine but I forgot where I took it from
...
def showOrientations(image, orientations, label, w=32, vmin=0.0, vmax=1.0):
    ...
    for y in range(0, height, w):
        for x in range(0, width, w):
            ...
            if(x+w > width or y + w > height): continue
    ...
    # o is the vector containing the local orientations of blocks of size w from the image
    print(len(o))
